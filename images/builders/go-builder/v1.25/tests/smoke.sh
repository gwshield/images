...
# =============================================================================
# Smoke tests for gwshield Go Builder v1.25
#
# Tests performed:
#   1. Container starts and reports the correct Go version (1.25.x)
...
#   7. Shell presence (informational — builder images retain /bin/sh intentionally)
#
# Usage:
#   bash tests/smoke.sh <image>
#   IMAGE=ghcr.io/gwshield/go-builder:v1.25 bash tests/smoke.sh
#
# Exit codes:
...
CONTAINER_NAME="go-builder-v125-smoke-$$"
EXPECTED_UID="65532"
EXPECTED_GO_MINOR="1.25"
...
# ---------------------------------------------------------------------------
# Test 1: Go version matches expected minor (1.25.x)
# ---------------------------------------------------------------------------
...
elif printf '%s' "${BUILD_OUT}" | grep -qi "successfully built\|naming to"; then
