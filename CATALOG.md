...
|---|---|---|---|---|---|
| `ghcr.io/gwshield/caddy:v2.11.2` | `v2.11.2` | standard | `2e592ebaa0b3` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/caddy:v2.11.2-cloudflare` | `v2.11.2-cloudflare` | cloudflare | `dcf4a8e62d48` | 0 CVEs | 2026-03-17 |
...
| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/pomerium:v0.32.2` | `v0.32.2` | standard | `1c9ee4b1d5b4` | 2 findings (0 critical, 2 high) | 2026-03-17 |
...
| `ghcr.io/gwshield/postgres:v15.17-vector` | `v15.17-vector` | pgvector | `4b16703005f8` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/postgres:v17.9` | `v17.9` | standard | `0bb4e7e118db` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/postgres:v17.9-cli` | `v17.9-cli` | client only | `72f020078d38` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/postgres:v17.9-timescale` | `v17.9-timescale` | TimescaleDB | `e504b288df75` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/postgres:v17.9-tls` | `v17.9-tls` | TLS | `1061ad1c5213` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/postgres:v17.9-vector` | `v17.9-vector` | pgvector | `f2f4a0613072` | 1 findings (0 critical, 1 high) | 2026-03-17 |

### Redis — in-memory data store

| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/redis:v7.4.8` | `v7.4.8` | standard | `1801f9f4d362` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/redis:v7.4.8-cli` | `v7.4.8-cli` | client only | `6b41b6dd1083` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/redis:v7.4.8-cluster` | `v7.4.8-cluster` | cluster mode | `65f2109b28f8` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/redis:v7.4.8-tls` | `v7.4.8-tls` | TLS | `b1a0010254a0` | 0 CVEs | 2026-03-17 |

### Traefik — cloud-native edge router

| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/traefik:v3.6.12` | `v3.6.12` | standard | `b0f79c639141` | 0 CVEs | 2026-03-30 |
...
| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/go-builder:v1.24` | `v1.24` | standard | `b14641959728` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/go-builder:v1.24-dev` | `v1.24-dev` | compile + test + lint | `60f96534ce8e` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/go-builder:v1.25` | `v1.25` | standard | `091bb7cfee83` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/go-builder:v1.25-dev` | `v1.25-dev` | compile + test + lint | `c0f73e2c5983` | 0 CVEs | 2026-03-17 |

### Python — reproducible wheel builds

| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/python-builder:v3.12` | `v3.12` | standard | `e7472ba44329` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/python-builder:v3.12-dev` | `v3.12-dev` | compile + test + lint | `28c8568d97b5` | 1 findings (0 critical, 1 high) | 2026-03-17 |
| `ghcr.io/gwshield/python-builder:v3.13` | `v3.13` | standard | `1316dab0a5dd` | 0 CVEs | 2026-03-17 |
| `ghcr.io/gwshield/python-builder:v3.13-dev` | `v3.13-dev` | compile + test + lint | `de8254096791` | 1 findings (0 critical, 1 high) | 2026-03-17 |
