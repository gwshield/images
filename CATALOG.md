...
|---|---|---|---|---|---|
| `ghcr.io/gwshield/caddy:v2.11.2` | `v2.11.2` | standard | `bb9e46b38cfa` | 44 findings (4 critical, 40 high) | 2026-03-31 |
| `ghcr.io/gwshield/caddy:v2.11.2-cloudflare` | `v2.11.2-cloudflare` | cloudflare | `75dc0397ec0b` | 34 findings (2 critical, 32 high) | 2026-04-10 |
...
| `ghcr.io/gwshield/caddy:v2.11.2-ratelimit` | `v2.11.2-ratelimit` | ratelimit | `9d6ab1d7fc67` | 48 findings (2 critical, 46 high) | 2026-04-09 |
| `ghcr.io/gwshield/caddy:v2.11.2-security` | `v2.11.2-security` | security | `9317f0986645` | 37 findings (2 critical, 35 high) | 2026-04-10 |
...
| `ghcr.io/gwshield/openresty:v1.29.2-lua` | `v1.29.2-lua` | lua | `c66c8c83f831` | 76 findings (8 critical, 68 high) | 2026-04-10 |

### OpenTelemetry Collector — observability pipeline

| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/otelcol:v0.147.0` | `v0.147.0` | standard | `221cd738a62f` | 57 findings (4 critical, 53 high) | 2026-04-10 |
...
| `ghcr.io/gwshield/php:v8.3-fpm-dev` | `v8.3-fpm-dev` | fpm-dev | `25dad794974d` | 750 findings (28 critical, 722 high) | 2026-04-10 |
| `ghcr.io/gwshield/php:v8.4-fpm` | `v8.4-fpm` | fpm | `518417f6e325` | 740 findings (28 critical, 712 high) | 2026-04-09 |
| `ghcr.io/gwshield/php:v8.4-fpm-dev` | `v8.4-fpm-dev` | fpm-dev | `cc057f39e11b` | 470 findings (32 critical, 438 high) | 2026-04-10 |

### Pomerium — identity-aware access proxy

| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/pomerium:v0.32.2` | `v0.32.2` | standard | `e76a5232375f` | 52 findings (4 critical, 48 high) | 2026-04-10 |
...
| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/traefik:v3.6.12` | `v3.6.12` | standard | `a6cc8bb2a699` | 48 findings (1 critical, 47 high) | 2026-04-10 |
| `ghcr.io/gwshield/traefik:v3.6.9` | `v3.6.9` | standard | `b1796eab8328` | 53 findings (2 critical, 51 high) | 2026-04-09 |
...
| Tag | Version | Profile | Digest | CVE status | Promoted |
|---|---|---|---|---|---|
| `ghcr.io/gwshield/go-builder:v1.24` | `v1.24` | standard | `23dbfafe6e00` | 397 findings (2 critical, 395 high) | 2026-04-10 |
| `ghcr.io/gwshield/go-builder:v1.24-dev` | `v1.24-dev` | compile + test + lint | `1eaea9617b1c` | 504 findings (2 critical, 502 high) | 2026-04-10 |
| `ghcr.io/gwshield/go-builder:v1.25` | `v1.25` | standard | `d459aec10a4c` | 179 findings (2 critical, 177 high) | 2026-04-10 |
| `ghcr.io/gwshield/go-builder:v1.25-dev` | `v1.25-dev` | compile + test + lint | `262f1c03ce0f` | 282 findings (2 critical, 280 high) | 2026-04-09 |
