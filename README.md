...
| `ghcr.io/gwshield/haproxy:v3.1.16-ssl` | `v3.1.16-ssl` | ssl | `d98a4be07b69` | 0 CVEs | 2026-03-13 |
...
| `ghcr.io/gwshield/valkey:v8.1.6-tls` | `v8.1.6-tls` | TLS | `d91276a9987c` | 0 CVEs | 2026-03-13 |
